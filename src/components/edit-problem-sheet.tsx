          ...
          <div className="flex min-h-0 min-w-0 flex-1">
            <div className="flex w-72 shrink-0 flex-col gap-3 overflow-y-auto border-r px-5 py-4">
              <div className="grid gap-1.5">
                <Label htmlFor="edit-problem-url" className="text-xs">
              ...
              <div className="grid gap-1.5">
                <Label htmlFor="edit-problem-name" className="text-xs">Problem Name</Label>
                <Input
              ...
              <div className="grid gap-1.5">
                <Label htmlFor="edit-tags" className="text-xs">Tags</Label>
                <TagsInput
              ...
              <div className="grid gap-1.5">
                <Label htmlFor="edit-date" className="text-xs">AC Time</Label>
                <Input
                  id="edit-date"
                  type="datetime-local"
